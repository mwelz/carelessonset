...
// calculate a LongStringPattern sequence
// J is the length of the pattern of imterest before the pattern starts anew. 
// For instance, the pattern 1-2-3-4-1-2-3-4 has length 4. J=1 yields straightlining.
// [[Rcpp::export]]
